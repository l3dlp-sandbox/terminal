...
namespace Microsoft::Terminal::Core
{
    ...
    public:
        ...
        virtual bool SendMouseEvent(const til::point viewportPos, const uint32_t uiButton, const ControlKeyStates states, const int32_t wheelDelta, const Microsoft::Console::VirtualTerminal::TerminalInput::MouseButtonState state) = 0;
