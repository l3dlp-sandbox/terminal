...
private:
    ...
    void FillBisect(ROW* pRow)
    {
        ...
        static constexpr std::array testStrings{
            TestString{ L" " },
            TestString{ L"ABCDEFGHIJKLMNOPQRSTUVWXYZ" },
            TestString{ L"\x304d", true },
            TestString{ L"0123456789" },
            TestString{ L"\x304d", true },
            TestString{ L"ABCDEFGHIJKLMNOPQRSTUVWXYZ" },
            TestString{ L"\x304d", true },
            TestString{ L"0123456789" },
        ...
        pRow->SetAttrToEnd(0, gci.GetActiveOutputBuffer().GetAttributes());
